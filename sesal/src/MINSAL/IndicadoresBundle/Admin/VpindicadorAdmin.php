...
use MINSAL\IndicadoresBundle\Entity\Vpindicador;

class VpindicadorAdmin extends Admin
{
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        ...
        $formMapper
                ...
                ->add('idindicador', null, array('label' => $this->getTranslator()->trans('id Variable'), 'required' => true))
                ->add('descripcion', null, array('label' => $this->getTranslator()->trans('Descripcion'), 'required' => true))
                ->add('periodo','choice',array('choices' => array('2014' => '2014', '2015' => '2015', '2016' => '2016', '2017' => '2017', '2018' => '2018', '2019' => '2019', '2020' => '2020')))
                ->add('estado', 'checkbox', array('label' => $this->getTranslator()->trans('Estado Activo'), 'required' => false, 'property_path' => 'false'))
                ->add('pintar','choice',array('choices' => array(false => 'NO', true => 'SI')))
                ->add('tipo','choice',array('choices' => array('G' => 'Generales', 'H' => 'Hospitales')))
    ...
    protected function configureListFields(ListMapper $listMapper)
    {
        ...
        $listMapper
                ...
                ->add('idindicador', null, array('label' => $this->getTranslator()->trans('id Variable')))
                ...
                ->add('tipo', null, array('label' => $this->getTranslator()->trans('tipo')))
                ->add('estado', null, array('label' => $this->getTranslator()->trans('estado')))
                ->add('pintar', null, array('label' => $this->getTranslator()->trans('pintar')))
    ...
    public function getTemplate($name)
    {
        switch ($name) {
            case 'edit':
                return 'IndicadoresBundle:CRUD:vpindicador-edit.html.twig';
                break;
		case 'list':
                return 'IndicadoresBundle:CRUD:vpindicador-list.html.twig';
                break;
            default:
