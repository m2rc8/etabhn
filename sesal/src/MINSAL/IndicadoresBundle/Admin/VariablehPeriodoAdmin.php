...
class VariablehPeriodoAdmin extends Admin
{
        ...
        if ($esFusionado == false)
            $formMapper
                 ...
                 ->with('Periodos Habiles')
                    ->add('aniosh', null, array('label' => 'Periodos', 'required' => false, 'expanded' => true))
                ->end()
    ...
    public function validate(ErrorElement $errorElement, $object)
    {
        ...
        $obj = new \MINSAL\IndicadoresBundle\Entity\VariablehPeriodo;
         
        $rowsRD = $this->getModelManager()->findBy('IndicadoresBundle:VariablehPeriodo',
    ...
    public function getTemplate($name)
    {
        switch ($name) {
            case 'edit':
                return 'IndicadoresBundle:CRUD:variableh_periodo-edit.html.twig';
                break;
		case 'list':
                return 'IndicadoresBundle:CRUD:variableh_periodo-list.html.twig';
                break;
            default:
